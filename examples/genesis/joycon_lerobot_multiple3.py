...
#添加机械臂
so_100_right = scene.add_entity(gs.morphs.MJCF(file= 'sim_env/so_100.xml', pos=(-0.30, 0.2, 0.75), euler= (0, 0, 0)))
so_100_left = scene.add_entity(gs.morphs.MJCF(file= 'sim_env/so_100.xml', pos=(0.30, 0.2, 0.75), euler= (0, 0, 0)))
