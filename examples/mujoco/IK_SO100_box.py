...
def acos(value):
    return round(math.acos(value), 14)
...
class rtb_Kinematics():
    def __init__(self):
        ...
        #设置关节限位
        self.robot.qlim = [[-2.2, -3.14158, -0.2,    -2.0,  -3.14158], 
    ...
    def rtb_get_robot(self):
        ...
        E15 = rtb.ET.Rx()  
        # E16 = rtb.ET.Rx(np.pi / 2)
        
        E17 = rtb.ET.tx(0.09538)
        # to gripper
        # E16 = rtb.ET.Ry(np.pi / 2)
        
        so100 = E1*E2*E3*E4*E5*E6*E7*E8*E9*E10*E11*E12*E13*E14*E15*E17 # *E16
        print(so100)
    ...
    def rtb_inverse_kinematics(self, q_now, target_pose):
        ...
        sol = self.robot.ikine_LM(Tep = T, q0=q_now) # , method="wampler"
